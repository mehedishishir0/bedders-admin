  ...
  const updateMutation = useMutation({
    mutationFn: async (data: CouponFormValues) => {
      ...
      const payload = {
        ...
        price: 100, // Example price, modify if needed
        discountValue: Number(data.discountValue.replace("%", "")),
        allUsers: data.validityTarget === "All Users",
        firstTime: data.validityTarget === "First-Time Users",
        totalUsageLimit: Number(data.totalUsageLimit),
